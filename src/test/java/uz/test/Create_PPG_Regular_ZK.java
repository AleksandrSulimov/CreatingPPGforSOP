...
public class Create_PPG_Regular_ZK extends TestCasesBase{

	@Title("Создание ППГ обычная - Запрос котировок")
    @Test
	public void create_PPG_Regular() throws AWTException{
		...
		Serenity.setSessionVariable("test_name").to("Создание ППГ обычная - Запрос котировок");
		...
		selectValueInMethodForDeterminingSupplierDictionary("Запрос котировок");
