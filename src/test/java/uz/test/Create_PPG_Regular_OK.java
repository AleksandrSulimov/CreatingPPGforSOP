...
public class Create_PPG_Regular_OK extends TestCasesBase{

	@Title("Создание ППГ обычная - Открытый конкурс")
    @Test
	public void create_PPG_Regular() throws AWTException{
		...
		Serenity.setSessionVariable("test_name").to("Создание ППГ обычная - Открытый конкурс");
